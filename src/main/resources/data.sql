...
INSERT INTO ACCOUNT(ACCOUNT_ID,ISADMIN,EMAIL,PASSWORD, FIRSTNAME, LASTNAME, ISACTIVE) VALUES (SQ_ACCOUNT_PK.NEXTVAL,true,'ssshivam.aashir@gmail.com','password', 'sssshivam', 'AA', true);
