...
public class RestAssuredTest {
	...
	public void testEmailIsUpdatedUsingPatch() {
		...
		String email = accountService.getAccount(2).getEmail();
		 ...
		 RestAssured.given()
					 ...
					 .expect()
					 .body(equalTo("{\"accountId\":2,\"firstName\":\"shivam\",\"lastName\":\"A\",\"email\":\"j@email.com\",\"isAdmin\":true,\"password\":\"\",\"isActive\":true}"))
					 .when()
					 .patch("/email/2");
	...
	public void testFirstNameIsUpdatedUsingPatch() {
		...
		String firstName = accountService.getAccount(1).getFirstName();
		 ...
		 RestAssured.given()
					 .formParam("firstName", "kev")
					 .expect()
					 .body(equalTo("{\"accountId\":1,\"firstName\":\"kev\",\"lastName\":\"M\",\"email\":\"collinmeaney375@gmail.com\",\"isAdmin\":true,\"password\":\"\",\"isActive\":true}"))
					 .when()
					 .patch("/firstname/1");
	...
	public void testLastNameIsUpdatedUsingPatch() {
		String lastName = accountService.getAccount(1).getLastName();
		 RestAssured.given()
					 .formParam("lastName", "A")
					 .expect()
					 .body(equalTo("{\"accountId\":1,\"firstName\":\"collin\",\"lastName\":\"A\",\"email\":\"collinmeaney375@gmail.com\",\"isAdmin\":true,\"password\":\"\",\"isActive\":true}"))
					 .when()
					 .patch("/lastname/1");
	...
	public void testAccountStateIsUpdatedWithPatch() {
		Boolean accountState = accountService.getAccount(1).getIsActive();
		 RestAssured.given()
					 .formParam("lastName", "A")
					 .expect()
					 .body(equalTo("{\"accountId\":1,\"firstName\":\"collin\",\"lastName\":\"M\",\"email\":\"collinmeaney375@gmail.com\",\"isAdmin\":true,\"password\":\"\",\"isActive\":false}"))
					 .when()
					 .patch("/active-state/1");
